@php
    $isClaimOpen = Request::is('claim_request_form') || Request::is('advance/salary/apply') || Request::is('claim/loan/apply') || Request::is('claim/list/all') || Request::is('requested_details');
    $isClaimApplyOpen = Request::is('claim_request_form') || Request::is('advance/salary/apply') || Request::is('claim/loan/apply');
